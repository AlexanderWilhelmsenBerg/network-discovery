...
def init_db() -> None:
    ...
    _ensure_column("discovered_devices", "created_at", "created_at DATETIME NULL")
    _ensure_column("discovered_devices", "updated_at", "updated_at DATETIME NULL")
    _ensure_column("homelab_devices", "created_at", "created_at DATETIME NULL")
    _ensure_column("homelab_devices", "updated_at", "updated_at DATETIME NULL")
    ...
    _ensure_column("device_records", "created_at", "created_at DATETIME NULL")
    _ensure_column("device_records", "updated_at", "updated_at DATETIME NULL")
